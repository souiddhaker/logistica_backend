...
class CreateSubservicesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('sub_service_trip', function (Blueprint $table) {
            $table->integer('sub_service_id')->unsigned();
            $table->foreign('sub_service_id')->references('id')->on('subservices')->onDelete('cascade');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('sub_service_trip');
